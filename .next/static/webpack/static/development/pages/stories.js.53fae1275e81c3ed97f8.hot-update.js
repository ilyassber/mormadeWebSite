...
function MiddleNav(_ref) {
  ...
  return __jsx("div", {
    ...
    return __jsx("li", {
      className: "m-8 cursor-pointer text-base font-semibold md:text-xl  font-raleway tracking-wide  text-gray-900 hover:text-gray-700",
      key: indx,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=stories.js.53fae1275e81c3ed97f8.hot-update.js.map