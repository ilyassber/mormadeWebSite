...
var AddText = function AddText(props) {
  ...
  var editBtn = __jsx("div", {
    ...
    className: "h-auto w-auto flex content-center flex-wrap text-center bg-white bg-opacity-50 border border-1 border-gray-900 hover:bg-opacity-75",
    role: "button",
    onClick: function onClick() {
      var data = {
        state: "edit",
...
//# sourceMappingURL=maker.js.26b1e60565c62b582bab.hot-update.js.map