...
var Layout = function Layout(props) {
  ...
  function useLockBodyScroll() {
    ...
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
      // Prevent scrolling on mount
      console.log("hola hoal : ", layoutRef.current); // Re-enable scrolling when component unmounts
    }, []);
  } // DISPLAYED CONTENT 
  ...
  return __jsx("div", {
    ref: layoutRef,
    className: "flex flex-col w-full h-full overflow-hidden overflow-x-hidden overflow-y-hidden",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 229,
...
//# sourceMappingURL=index.js.ef5f85f56cf1a6db2985.hot-update.js.map