...
var AddText = function AddText(props) {
  ...
  var content = __jsx("div", {
    ...
    rows: "4",
    cols: "50",
    className: "appearance-none border h-12 py-2 px-3 font-sans font-medium text-gray-700 leading-tight focus:outline-none focus:border-black",
    type: "text",
    ...
    className: "absolute top-0 right-0 container flex content-center flex-wrap text-center h-6 w-6 bg-opacity-50 bg-gray-700 rounded-full hover:bg-gray-900 focus:outline-none mt-2",
    role: "button",
    onClick: function onClick() {
...
//# sourceMappingURL=maker.js.fedaf4d46ac5479f9534.hot-update.js.map