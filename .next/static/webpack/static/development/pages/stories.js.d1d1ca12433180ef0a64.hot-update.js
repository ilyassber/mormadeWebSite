...
function BlackFocusScreen(_ref) {
  ...
  return __jsx("div", {
    className: display ? "absolute z-20 top-0 left-0 w-full h-full transition ease-out duration-500 bg-gray-900 bg-opacity-50" : "absolute h-full w-full z-20 transition ease-out duration-500 bg-opacity-100 bg-gray-900",
    onClick: onClick,
    __self: this,
    __source: {
...
//# sourceMappingURL=stories.js.d1d1ca12433180ef0a64.hot-update.js.map