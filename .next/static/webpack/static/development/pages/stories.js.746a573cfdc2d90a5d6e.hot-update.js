...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-center sm:w-full items-center md:min-w-2xl md:max-w-xl md:items-start ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48,
...
function RightCard(_ref3) {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-center sm:w-full items-center md:max-w-xl md:items-end ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
...
//# sourceMappingURL=stories.js.746a573cfdc2d90a5d6e.hot-update.js.map