...
function MiddleNav(_ref) {
  ...
  return __jsx("div", {
    ...
    return __jsx("li", {
      className: "m-8 cursor-pointer text-base font-semibold md:text-xl font-kumbhsans tracking-wide  text-gray-900 hover:text-gray-700",
      key: indx,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=stories.js.ab33962fd34487451dba.hot-update.js.map