...
function AlphaDisplayer(_ref) {
  ...
  return __jsx("div", {
    onClick: clickAction,
    className: " flex justify-center my-5 mx-5 cursor-pointer overflow-hidden",
    __self: this,
    __source: {
    ...
    className: "absolute flex flex-col justify-end items-center p-2 w-full h-full bg-yellow-600",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 15,
...
//# sourceMappingURL=index.js.d8e2de11995b893d3018.hot-update.js.map