...
function TitleBlock(_ref) {
  var children = _ref.children;
  return __jsx("div", {
    className: "absolute top-0 left-0 flex justify-between items-center w-full h-16 border-b border-gray-300 bg-gray-100",
    __self: this,
    __source: {
...
function SideMenu(_ref3) {
  var menuClick = _ref3.menuClick,
      changeMenuClicked = _ref3.changeMenuClicked,
      currentPage = _ref3.currentPage,
      changeCurrentPage = _ref3.changeCurrentPage,
      categories = _ref3.categories,
      max_shown = _ref3.max_shown,
      links = _ref3.links;
  return __jsx("nav", {
    className: "".concat(menuClick ? "transform translate-x-0 transition-all ease-out duration-500" : "transform -translate-x-full transition-all ease-out duration-500 ", " fixed flex-row  w-11/12  overflow-scroll z-30 h-full bg-white"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22,
    ...
    className: "flex justify-center items-center h-full p-5 bg-gray-400 border",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24,
...
//# sourceMappingURL=stories.js.5dd85ff92354dd345c5d.hot-update.js.map