...
function SideMenu(_ref) {
  ...
  return __jsx("nav", {
    className: "".concat(menuClick ? "fixed transform translate-x-0 transition-all ease-out duration-500" : "fixed transform -translate-x-11/12 transition-all ease-out duration-500 ", " w-11/12 z-20 h-full bg-white"),
...
//# sourceMappingURL=regions.js.be1e1780e521c3f18a9f.hot-update.js.map