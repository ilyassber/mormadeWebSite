...
function AlphaDisplayer(_ref) {
  ...
  var textStyle = {
    ...
    descriptionStyle: "leading-relaxed font-bold text-base text-center text-white",
  ...
  return __jsx("div", {
    ...
    className: "absolute flex flex-col justify-end items-center w-full h-full b",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 15,
...
//# sourceMappingURL=index.js.a12f3c0508eae9eab80a.hot-update.js.map