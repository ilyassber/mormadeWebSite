...
var AddText = function AddText(props) {
  ...
  var editBtn = __jsx("div", {
    ...
    className: "h-auto w-auto flex flex-wrap bg-white bg-opacity-50 border border-gray-900 hover:bg-opacity-75",
    role: "button",
    onClick: function onClick() {
      var data = {
        state: "edit",
...
//# sourceMappingURL=maker.js.c40178246fe2585350a7.hot-update.js.map