...
function ArticleCover(_ref) {
  ...
  return __jsx("div", {
    className: " flex flex-col justify-start items-center w-full h-288 ",
    __self: this,
    __source: {
    ...
    image: image,
    style: "flex-shrink w-288 h-204 overflow-hidden bg-gray-400 shadow-sm",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10,
    ...
    text: description,
    style: "m-10 w-6/12 h-72 bg-white shadow-sm",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11,
...
//# sourceMappingURL=index.js.062a165f3166080469b2.hot-update.js.map