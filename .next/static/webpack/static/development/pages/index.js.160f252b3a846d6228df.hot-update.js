...
function Footer(_ref) {
  ...
  var CategoriesCard = function CategoriesCard() {
    return __jsx("div", {
      className: "my-2 sm:mx:8 md:mx-10 lg:mx-5 flex lg:flex-1  flex-col justify-start items-start md:items-center md:items-start ",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 18,
...
//# sourceMappingURL=index.js.160f252b3a846d6228df.hot-update.js.map