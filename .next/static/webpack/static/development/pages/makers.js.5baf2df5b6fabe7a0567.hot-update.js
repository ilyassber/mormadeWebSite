...
function CategoriesBar(_ref2) {
  ...
  return __jsx("div", {
    ...
    return index < max_shown && __jsx("li", {
      key: index,
      className: "flex px-4 h-full justify-center items-center cursor-pointer font-lato text-sm font-black tracking-widest ".concat(openCategorie.categorie && openCategorie.categorie === categorie ? "text-gray-900 border-b-2 border-gray-900" : "text-gray-900 hover:text-gray-700"),
...
//# sourceMappingURL=makers.js.5baf2df5b6fabe7a0567.hot-update.js.map