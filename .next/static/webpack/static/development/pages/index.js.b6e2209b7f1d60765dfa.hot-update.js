...
var categoriesStyles = {
  fixed: "fixed top-0 hidden md:flex flex-col w-full bg-purple-500",
  notFixed: "absolute hidden md:flex flex-col w-full bg-orange-600",
...
function NavBar(_ref) {
  ...
  return __jsx("nav", {
    ...
    className: "w-full shadow shadow-xl",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 61,
...
//# sourceMappingURL=index.js.b6e2209b7f1d60765dfa.hot-update.js.map