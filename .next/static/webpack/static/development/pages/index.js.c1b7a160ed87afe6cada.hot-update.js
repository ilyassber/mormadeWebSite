...
function ArticleCover(_ref) {
  ...
  return __jsx("div", {
    className: "relative flex flex-col justify-start items-center w-full h-288 bg-yellow-300",
    __self: this,
    __source: {
    ...
    title: title,
    style: "flex justify-center items-center w-64 h-32 font-bold text-3xl bg-white  text-gray-900",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9,
    ...
    image: image,
    style: "w-10/12 h-204 overflow-hidden bg-gray-400 shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10,
    ...
    text: description,
    style: "absolute bottom-4 w-6/12 h-72 bg-white opacity-75 shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11,
...
//# sourceMappingURL=index.js.c1b7a160ed87afe6cada.hot-update.js.map