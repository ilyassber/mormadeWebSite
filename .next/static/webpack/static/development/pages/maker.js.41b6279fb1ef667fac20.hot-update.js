...
var RemovableTag = function RemovableTag(props) {
  var content = __jsx("div", {
    ...
    className: "h-full w-auto pl-2 pr-2 bg-gray-900 rounded content-center mx-auto flex flex-wrap",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11,
    ...
    className: "h-auto w-auto bg-xw-100 rounded content-center mx-auto flex flex-wrap font-sans text-center text-gray-900 font-bold text-xs",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 15,
    ...
    className: "font-bold text-gray-900 text-center ml-1 mr-1",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 16,
...
//# sourceMappingURL=maker.js.41b6279fb1ef667fac20.hot-update.js.map