...
function MiddleNav(_ref) {
  ...
  return __jsx("div", {
    ...
    return __jsx("li", {
      className: "m-8 cursor-pointer text-base font-semibold md:text-xl font-grandstander tracking-wide  text-gray-900 hover:text-gray-700",
      key: indx,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=stories.js.ecce6243ca8e7edb2e4d.hot-update.js.map