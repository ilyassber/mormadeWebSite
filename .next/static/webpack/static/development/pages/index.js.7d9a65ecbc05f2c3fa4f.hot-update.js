...
function ArticleCover(_ref) {
  ...
  return __jsx("div", {
    className: "relative flex flex-col justify-start items-center w-full h-288 ",
    __self: this,
    __source: {
    ...
    text: description,
    style: "absolute bottom-4 w-6/12 h-72 bg-white shadow-xl",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11,
...
//# sourceMappingURL=index.js.7d9a65ecbc05f2c3fa4f.hot-update.js.map