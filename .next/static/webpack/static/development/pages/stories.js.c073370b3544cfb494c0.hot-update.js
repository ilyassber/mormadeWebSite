...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    className: "flex flex-row justify-center w-6/12 m-5",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43,
    ...
    className: "flex flex-col justify-center items-center p-5 pr-10 md:p-16 w-204 ".concat(descriptionHeight, " bg-white"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
...
//# sourceMappingURL=stories.js.c073370b3544cfb494c0.hot-update.js.map