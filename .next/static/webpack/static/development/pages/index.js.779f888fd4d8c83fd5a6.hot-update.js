...
function AlphaDisplayer(_ref) {
  ...
  var textStyle = {
    ...
    descriptionStyle: "tracking-wide font-bold text-base text-center text-white",
    buttonStyle: "font-yantramanav text-sm font-bold"
  };
  return __jsx("div", {
    ...
    className: "absolute flex flex-col justify-end items-center w-full h-full bg-gray-500",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 15,
    ...
    className: "flex justify-center items-center px-5 py-2 m-10 bg-white ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19,
...
//# sourceMappingURL=index.js.779f888fd4d8c83fd5a6.hot-update.js.map