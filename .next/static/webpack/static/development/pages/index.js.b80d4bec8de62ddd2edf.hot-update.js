...
function AlphaDisplayer(_ref) {
  ...
  return __jsx("div", {
    ...
    image: image,
    height: height,
    style: "flex flex-col justify-end items-center m-1 sm:m-10 ".concat(height, " ").concat(width, " shadow-xl"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14,
...
//# sourceMappingURL=index.js.b80d4bec8de62ddd2edf.hot-update.js.map