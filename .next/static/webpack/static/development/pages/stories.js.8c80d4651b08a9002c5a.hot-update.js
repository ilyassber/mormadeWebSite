...
function NavBar(_ref) {
  ...
  return __jsx("nav", {
    ...
    return __jsx("li", {
      className: "m-8 cursor-pointer text-sm md:text-2xl font-worksans  text-gray-900 hover:text-gray-500",
      key: indx,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=stories.js.8c80d4651b08a9002c5a.hot-update.js.map