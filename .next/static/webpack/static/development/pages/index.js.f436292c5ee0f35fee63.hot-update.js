...
function NavBar(_ref) {
  ...
  var i_size = 15;
  return __jsx("nav", {
    className: "".concat(menuClicked ? "h-full bg-opacity-50" : "", " z-10 fixed flex-row w-full font-sans bg-white"),
    __self: this,
    __source: {
    ...
    className: "".concat(menuClicked ? "hidden" : "", " flex flex-col justify-between w-full pl-5 pr-5"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 49,
...
//# sourceMappingURL=index.js.f436292c5ee0f35fee63.hot-update.js.map