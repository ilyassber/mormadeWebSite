...
function RightCard(_ref3) {
  var image = _ref3.image,
      ...
      style = _ref3.style;
  var styleFont = {
    titleStyle: "my-4 font-kumbhsans font-bold  md:text-xl hover:underline cursor-pointer text-center md:text-right break-words",
    descriptionStyle: "font-amiri text-base text-center md:text-right",
    linkStyle: "my-2 font-yantramanav text-sm font-bold"
  };
  return __jsx("div", {
...
//# sourceMappingURL=stories.js.b4cdcef1e57e4feac0b0.hot-update.js.map