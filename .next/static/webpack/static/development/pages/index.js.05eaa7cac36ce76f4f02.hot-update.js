...
function Footer(_ref) {
  ...
  var CategoriesCard = function CategoriesCard() {
    return __jsx("div", {
      className: "my-2 mx-5 flex lg:flex-1  flex-col justify-start items-start md:items-center md:items-start lg:pl-10 bg-red-500",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 18,
  ...
  var EntriesCard = function EntriesCard() {
    return __jsx("div", {
      className: "my-2 mx-5 flex lg:flex-1 flex-col justify-start items-start md:items-center md:items-start",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 32,
  ...
  return __jsx("div", {
    ...
    className: "my-10 flex flex-col lg:flex-row justify-start lg:justify-around items-center w-full h-auto bg-gray-600",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 52,
    ...
    className: "my-5 md:my-5 flex flex-1 flex-col md:flex-row items-start md:justify-center lg:justify-between  w-full  bg-gray-800",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 53,
    ...
    className: "mx-5 w-full h-full flex flex-1 justify-center items-center md:w-auto text-gray-500",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 57,
...
//# sourceMappingURL=index.js.05eaa7cac36ce76f4f02.hot-update.js.map