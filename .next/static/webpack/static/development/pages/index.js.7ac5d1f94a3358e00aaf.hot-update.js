...
function AlphaDisplayer(_ref) {
  ...
  var textStyle = {
    titleStyle: "font-kumbhsans font-bold  md:text-xl hover:underline text-center break-words text-white",
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-center items-center bg-opacity-75  w-10/12 h-4/12 ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 16,
...
//# sourceMappingURL=index.js.7ac5d1f94a3358e00aaf.hot-update.js.map