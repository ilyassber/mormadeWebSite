...
function ArticleCover(_ref) {
  ...
  return __jsx("div", {
    ...
    title: title,
    style: "flex justify-center items-center w-64 h-24 font-bold text-3xl bg-white  text-gray-900",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9,
    ...
    image: image,
    style: "w-11/12 h-180 overflow-hidden bg-gray-400",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10,
...
//# sourceMappingURL=index.js.dc5a03a6989523ad5f08.hot-update.js.map