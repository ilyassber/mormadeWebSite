...
function RightCard(_ref3) {
  ...
  return __jsx("div", {
    ...
    className: "flex justify-center max-w-md min-w-full  ".concat(descriptionHeight, " "),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 72,
    ...
    className: "flex flex-col justify-center w-full items-center p-10 md:items-end ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
...
//# sourceMappingURL=stories.js.3652d84939b303bea750.hot-update.js.map