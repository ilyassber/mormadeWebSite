...
function CentredCard(_ref) {
  var image = _ref.image,
      ...
      style = _ref.style;
  var styleFont = {
    titleStyle: "font-kumbhsans font-bold text-xl hover:underline cursor-pointer text-center",
...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-center items-start p-16 ".concat(descriptionWidth, " h-full bg-white shadow-lg"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44,
...
//# sourceMappingURL=stories.js.e49863526b5e74a2ef78.hot-update.js.map