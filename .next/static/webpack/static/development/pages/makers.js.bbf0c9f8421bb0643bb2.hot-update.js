...
var WaitList = function WaitList(props) {
  ...
  var content = __jsx("div", {
    ...
    className: "h-auto w-full font-roboto font-bold text-white text-4xl text-left align-left mb-6",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 55,
    ...
    className: "h-auto w-full font-bold text-white text-4xl text-right align-right mb-6",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 58,
    ...
    className: "h-auto w-full font-roboto text-white text-base text-center align-center mb-6",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 61,
...
//# sourceMappingURL=makers.js.bbf0c9f8421bb0643bb2.hot-update.js.map