...
function NavBar(_ref) {
  ...
  return __jsx("nav", {
    ...
    return __jsx("li", {
      className: "m-8 cursor-pointer text-sm md:text-xl font-bold text-gray-900 hover:text-gray-500",
      key: indx,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=regions.js.974f7c2fb80859157a2d.hot-update.js.map