...
function Cover1(_ref2) {
  ...
  return __jsx("div", {
    className: "relative flex overflow-hidden my-16 mx-16 bg-gray-900",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18,
    ...
    className: "absolute flex justify-center items-end w-full h-full bg-gray-500 bg-opacity-75",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20,
    ...
    className: "flex flex-col justify-center items-center bg-red-200 w-1/2 h-4/12",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21,
    ...
    className: "flex justify-center items-center bg-white w-4/12 h-2/12",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24,
...
//# sourceMappingURL=stories.js.d62bfc77adef19646cd8.hot-update.js.map