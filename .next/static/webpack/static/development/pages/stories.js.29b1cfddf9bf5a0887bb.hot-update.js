...
function LeftCard(_ref2) {
  var image = _ref2.image,
      ...
      style = _ref2.style;
  var styleFont = {
    titleStyle: "font-kumbhsans font-bold  md:text-xl hover:underline cursor-pointer text-left ",
    descriptionStyle: "font-amiri text-base text-left",
    linkStyle: "font-yantramanav text-sm font-bold text-left"
  };
  return __jsx("div", {
    className: "flex flex-row items-center justify-start max-w-xl  m-5 bg-white ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43,
    ...
    className: "flex flex-col justify-center items-center ".concat(descriptionHeight, " bg-gray-600 bg-opacity-50"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
  ...
  }, title), __jsx(next_link__WEBPACK_IMPORTED_MODULE_3___default.a, {
    href: link.path,
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=stories.js.29b1cfddf9bf5a0887bb.hot-update.js.map