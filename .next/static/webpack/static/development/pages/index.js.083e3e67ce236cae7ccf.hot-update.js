...
var Btn = function Btn(props) {
  ...
  var content = __jsx("div", {
    ...
    className: 'w-full h-full bg-' + bgColor + ' ' + shadow + ' hover:bg-' + hoverColor + ' focus:outline-none hover:border-' + hoverColor + ' font-roboto font-' + textWeight + ' text-white text-' + textSize + ' py-2 px-4',
    type: "button",
...
//# sourceMappingURL=index.js.083e3e67ce236cae7ccf.hot-update.js.map