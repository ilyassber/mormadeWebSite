...
function SousCategoriesBar(_ref) {
  ...
  return __jsx("div", {
    className: hovredCategorie.hovered ? "transform transition-all ease-out duration-500 flex flex-col items-center w-full bg-white" : "transform h-0 transition-all ease-out duration-500 w-full overflow-hidden bg-white",
    onMouseEnter: show,
    onMouseLeave: hide,
    __self: this,
    __source: {
...
//# sourceMappingURL=index.js.4d37c24bbc2cf04c9be5.hot-update.js.map