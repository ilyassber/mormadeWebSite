...
function MiddleNav(_ref) {
  ...
  return __jsx("div", {
    ...
    return __jsx("li", {
      className: "m-8 cursor-pointer text-amiri text-base font-bold font-relway tracking-wide  text-gray-900 hover:text-gray-700",
      key: indx,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.2a144941fa4663361a9e.hot-update.js.map