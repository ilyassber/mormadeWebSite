...
var WaitList = function WaitList(props) {
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])('JOIN OUR NEWSLETTER, TO BE IN TOUCH'),
  ...
  var content = __jsx("div", {
    ...
    className: "h-auto w-full text-white text-3xl text-left align-left mb-6",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 55,
    ...
    className: "h-auto w-full text-white text-3xl text-right align-right mb-6",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 58,
    ...
    className: "h-auto w-full text-white text-base text-center align-center mb-6",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 61,
...
//# sourceMappingURL=makers.js.cdcfcdab43c8ee77bc05.hot-update.js.map