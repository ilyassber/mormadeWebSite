...
function SideMenu(_ref) {
  ...
  return __jsx("nav", {
    className: "".concat(menuClick ? "bg-gray-900 bg-opacity-50" : "hidden", " fixed z-20 w-full h-full"),
    ...
    className: "".concat(menuClick ? "transform translate-x-0 transition-all ease-out duration-500" : "transform -translate-x-full transition-all ease-out duration-500 ", " flex w-11/12 z-20 h-full bg-white"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8,
  ...
  }, console.log("menu : ", menuClick ? "clicked " : "not clicked "), __jsx("h1", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10,
...
//# sourceMappingURL=regions.js.0de8477779b9fbe2e5d5.hot-update.js.map