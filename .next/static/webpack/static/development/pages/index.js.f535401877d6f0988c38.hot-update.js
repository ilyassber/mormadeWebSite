...
function AlphaDisplayer(_ref) {
  ...
  return __jsx("div", {
    ...
    image: image,
    height: height,
    style: "flex flex-col justify-end items-center m-10 ".concat(height, " ").concat(width, " shadow-lg"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14,
...
//# sourceMappingURL=index.js.f535401877d6f0988c38.hot-update.js.map