...
var AddProduct = function AddProduct(props) {
  ...
  var removeCategory = function removeCategory(index) {
    var catList = [];
    catList.concat(categories);
    catList.splice(index, categories.length - index);
    setCategories(catList); //categories.splice(index, (categories.length - index))
  };
...
//# sourceMappingURL=maker.js.5f3923f7c729cd6aea9a.hot-update.js.map