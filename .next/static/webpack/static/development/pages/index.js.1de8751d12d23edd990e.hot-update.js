...
function AlphaDisplayer(_ref) {
  ...
  return __jsx("div", {
    onClick: clickAction,
    className: " relative flex justify-center py-5 px-5 cursor-pointer overflow-hidden",
    __self: this,
    __source: {
    ...
    className: "flex flex-col justify-end items-center p-2 w-full h-full ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 16,
...
//# sourceMappingURL=index.js.1de8751d12d23edd990e.hot-update.js.map