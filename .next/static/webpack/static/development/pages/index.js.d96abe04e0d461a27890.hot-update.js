...
function AlphaDisplayer(_ref) {
  ...
  return __jsx("div", {
    onClick: clickAction,
    className: "relative flex justify-center my-5 mx-5 cursor-pointer ",
    __self: this,
    __source: {
    ...
    className: "absolute flex justify-center w-full h-full overflow-hidden",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14,
...
//# sourceMappingURL=index.js.d96abe04e0d461a27890.hot-update.js.map