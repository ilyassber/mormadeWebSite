...
function CategoriesBar(_ref2) {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row justify-between h-14 w-full",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 53,
    ...
    return index < max_shown && __jsx("li", {
      key: index,
      className: "flex px-4 h-full justify-center items-center cursor-pointer font-lato text-base font-black ".concat(openCategorie.categorie && openCategorie.categorie === categorie ? "text-yellow-600" : "text-white hover:text-gray-700"),
...
//# sourceMappingURL=index.js.2fd03d73b851d09cbd37.hot-update.js.map