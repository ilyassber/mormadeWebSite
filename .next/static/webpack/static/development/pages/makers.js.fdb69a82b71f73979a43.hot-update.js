...
function CategoriesBar(_ref2) {
  ...
  return __jsx("div", {
    ...
    return index < max_shown && __jsx("li", {
      key: index,
      className: "flex px-4 h-full justify-center items-center cursor-pointer font-lato text-sm font-black tracking-widest ".concat(openCategorie.categorie && openCategorie.categorie === categorie ? "text-gray-900 border-b-4 border-black" : "text-gray-900 border-b-4 border-transparent"),
...
//# sourceMappingURL=makers.js.fdb69a82b71f73979a43.hot-update.js.map