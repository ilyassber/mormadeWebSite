...
function NavBar(_ref) {
  ...
  var i_size = 15;
  return __jsx("nav", {
    className: "".concat(menuClicked ? "h-full bg-opacity-50 bg-gray-900" : "", "  z-10 fixed  w-full"),
    __self: this,
    __source: {
    ...
    className: "".concat(menuClicked ? "bg-opacity-50 bg-gray-900" : "", "  flex-row w-full font-sans bg-white"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 49,
...
//# sourceMappingURL=index.js.f833722d1015d6da1d54.hot-update.js.map