...
function SideMenu(_ref) {
  ...
  return __jsx("nav", {
    className: "".concat(menuClick ? "transform translate-x-0 transition-all ease-out duration-500" : "transform -translate-x-full transition-all ease-out duration-500 ", " fixed flex-row w-11/12 z-30 h-full bg-gray-200"),
    __self: this,
    __source: {
    ...
    className: "w-full h-1/12 bg-red-400",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6,
...
//# sourceMappingURL=stories.js.fc811dc9babf0f21eb57.hot-update.js.map