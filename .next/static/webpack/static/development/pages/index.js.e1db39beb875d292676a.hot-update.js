...
function Footer(_ref) {
  ...
  var CategoriesCard = function CategoriesCard() {
    return __jsx("div", {
      className: "my-2 sm:mx-8 md:mx-10 lg:mx-5 flex lg:flex-1  flex-col justify-start items-center ",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 18,
  ...
  return __jsx("div", {
    ...
    className: "my-10 flex flex-col lg:flex-row justify-start lg:justify-around items-center w-full h-auto bg-red-400",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 52,
    ...
    className: "mb-5 sm:mb-10 flex flex-1 flex-col sm:flex-row itmes-center sm:items-start sm:justify-center lg:justify-between  w-full  ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 53,
    ...
    className: "mx-5 w-full flex flex-1 justify-center items-center md:w-auto text-gray-500",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 57,
...
//# sourceMappingURL=index.js.e1db39beb875d292676a.hot-update.js.map