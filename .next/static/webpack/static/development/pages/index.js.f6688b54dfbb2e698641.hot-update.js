...
function Footer(_ref) {
  ...
  var CategoriesCard = function CategoriesCard() {
    return __jsx("div", {
      className: "my-2 mx-5 flex lg:flex-1  flex-col justify-start items-start md:items-center md:items-start lg:pl-10 ",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 18,
  ...
  return __jsx("div", {
    ...
    className: "my-5 md:my-5 flex flex-1 flex-col md:flex-row items-start md:justify-center lg:justify-between  w-full  ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 53,
    ...
    className: "mx-5 w-full h-full flex flex-1 md:justify-center items-center md:w-auto text-gray-500",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 57,
...
//# sourceMappingURL=index.js.f6688b54dfbb2e698641.hot-update.js.map