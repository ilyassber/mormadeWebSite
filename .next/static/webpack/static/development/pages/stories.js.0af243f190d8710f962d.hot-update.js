...
function NavBar(_ref) {
  ...
  return __jsx("nav", {
    ...
    return __jsx("li", {
      className: "m-8 cursor-pointer text-sm md:text-xl text-xl font-worksans  text-gray-900 hover:text-gray-500",
      key: indx,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=stories.js.0af243f190d8710f962d.hot-update.js.map