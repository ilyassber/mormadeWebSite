...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    className: "flex flex-row items-center justify-start max-w-6xl bg-white ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43,
    ...
    className: "flex flex-col justify-center items-start w-3/12 ".concat(descriptionHeight, " "),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
...
//# sourceMappingURL=stories.js.a0d5a222fdc5884ce8df.hot-update.js.map