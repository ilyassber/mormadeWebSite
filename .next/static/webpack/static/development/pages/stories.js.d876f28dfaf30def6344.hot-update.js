...
function CentredCard(_ref) {
  ...
  return __jsx("div", {
    className: "".concat(style, " flex flex-col justify-center shadow-2xl ").concat(width),
    __self: this,
    __source: {
    ...
    image: image,
    height: imageHeight,
    style: "flex justify-center items-center ".concat(imageHeight, " w-full  overflow-hidden"),
    imageStyle: "",
    __self: this,
    __source: {
      fileName: _jsxFileName,
    ...
    className: "flex flex-col justify-start items-center p-2 pl-10 pr-10 md:p-16 ".concat(descriptionHeight, " w-full bg-white"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19,
    ...
    text: description,
    style: "hidden md:block md:mt-2 md:mb-2  text-gray-900 ",
...
//# sourceMappingURL=stories.js.d876f28dfaf30def6344.hot-update.js.map