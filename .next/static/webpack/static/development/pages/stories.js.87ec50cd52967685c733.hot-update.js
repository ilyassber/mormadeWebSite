...
function Cover1(_ref2) {
  ...
  return __jsx("div", {
    className: "relative flex justify-center items-center overflow-hidden my-16 mx-16 bg-gray-900",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18,
    ...
    className: "object-cover object-center ".concat(imageStyle),
    src: image,
    alt: "image cover",
    __self: this,
    __source: {
    ...
    className: "absolute flex justify-center items-center bg-white opacity-50 w-11/12 h-11/12",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20,
...
//# sourceMappingURL=stories.js.87ec50cd52967685c733.hot-update.js.map