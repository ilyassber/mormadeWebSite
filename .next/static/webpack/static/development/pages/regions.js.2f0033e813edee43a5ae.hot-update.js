...
function SideMenu(_ref) {
  ...
  return __jsx("nav", {
    className: "".concat(menuClick ? "transform translate-x-0 transition-all ease-out duration-500" : "transform -translate-x-full transition-all ease-out duration-500 ", " fixed w-full z-20 h-full bg-white"),
...
//# sourceMappingURL=regions.js.2f0033e813edee43a5ae.hot-update.js.map