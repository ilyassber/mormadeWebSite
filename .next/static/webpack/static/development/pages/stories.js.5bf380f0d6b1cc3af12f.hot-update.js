...
function ArticleContent(_ref) {
  ...
  return __jsx("div", {
    ...
    image: image,
    height: "h-72",
    style: "flex items-center mr-10 w-180 h-72 rounded-sm overflow-hidden shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8,
...
function ArticleContent1(_ref2) {
  ...
  return __jsx("div", {
    ...
    text: text,
    style: "flex flex-1 justify-center items-center p-20  w-144 h-full  ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18,
...
function ArticleContent2(_ref3) {
  var image = _ref3.image,
      ...
      title = _ref3.title;
  return __jsx("div", {
    className: "flex flex-row mt-20 mb-20 w-full h-180 ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27,
    ...
    image: image,
    height: "h-180",
    style: "flex flex-1 items-center w-180 h-180 rounded-full overflow-hidden shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28,
...
//# sourceMappingURL=stories.js.5bf380f0d6b1cc3af12f.hot-update.js.map