...
function CategoriesBar(_ref2) {
  ...
  return __jsx("div", {
    ...
    return index < max_shown && __jsx("li", {
      key: index,
      className: "flex px-4 h-full justify-center items-center cursor-pointer font-lato text-sm font-black tracking-widest ".concat(openCategorie.categorie && openCategorie.categorie === categorie ? "text-gray-900 border-b-3 border-black" : "text-gray-900 border-b-3 border-transparent"),
...
//# sourceMappingURL=makers.js.5254907c8dc2478b0fca.hot-update.js.map