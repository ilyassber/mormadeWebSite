...
function NavBar(_ref) {
  ...
  return __jsx("nav", {
    ...
    className: "text-3xl  whitespace-no-wrap",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 38,
    ...
    return __jsx("li", {
      className: "m-8 cursor-pointer text-xl font-amiri hover:text-gray-500",
      key: indx,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
    ...
    className: "h-full w-24 outline-none border-b border-gray-500 focus:w-56",
    type: "text",
    placeholder: "search",
    style: input_style,
    __self: this,
...
//# sourceMappingURL=index.js.ea269d27907da04d5c2e.hot-update.js.map