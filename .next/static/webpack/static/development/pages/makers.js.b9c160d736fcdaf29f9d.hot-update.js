...
function CategoriesBar(_ref2) {
  ...
  return __jsx("div", {
    ...
    return index < max_shown && __jsx("li", {
      key: index,
      className: "flex px-4 h-full justify-center items-center cursor-pointer font-lato text-sm font-black tracking-widest ".concat(openCategorie.categorie && openCategorie.categorie === categorie ? "text-yellow-600" : "text-gray-900 hover:text-gray-700"),
...
//# sourceMappingURL=makers.js.b9c160d736fcdaf29f9d.hot-update.js.map