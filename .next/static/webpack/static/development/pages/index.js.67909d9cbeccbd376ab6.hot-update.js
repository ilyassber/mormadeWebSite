...
function SousCategoriesBar(_ref) {
  ...
  return __jsx("div", {
    className: hovredCategorie.hovered ? "transform h-auto transition-all ease-out duration-500 flex flex-col items-center w-full bg-white" : "transform h-0 transition-all ease-out duration-500 w-full overflow-hidden bg-white",
    onMouseEnter: show,
    onMouseLeave: hide,
    __self: this,
    __source: {
    ...
    className: "flex justify-between  flex-shrink-0 w-8/12 w-full",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14,
...
//# sourceMappingURL=index.js.67909d9cbeccbd376ab6.hot-update.js.map