...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    className: "flex flex-row justify-center w-8/12 m-5",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43,
    ...
    className: "flex flex-col justify-center items-center p-5 pr-10 md:p-16 w-6/12 ".concat(descriptionHeight, " bg-white"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
...
function StoryEntry(_ref4) {
  ...
  var sizeStyle = {
    1: {
      width: "",
      descriptionSize: "",
      style: "flex flex-row justify-start w-full"
    },
    2: {
      width: "max-w-4xl",
      descriptionSize: "",
...
//# sourceMappingURL=stories.js.e989a0338a01fb73a8b7.hot-update.js.map