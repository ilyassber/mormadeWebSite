...
function Footer(_ref) {
  ...
  return __jsx("div", {
    ...
    className: "mb-5 sm:mb-10 flex flex-1 flex-col sm:flex-row items-start justify-center lg:justify-between  w-full  ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 53,
    ...
    className: "mx-5 w-full flex flex-1 sm:justify-center items-center md:w-auto text-gray-500",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 57,
...
//# sourceMappingURL=index.js.83e8ce992c23ed96b8c2.hot-update.js.map