...
function NavBar(_ref) {
  ...
  var i_size = 15;
  return __jsx("nav", {
    className: "".concat(menuClicked ? "h-full bg-opacity-50 bg-gray-900" : "", "  z-10 relative w-full"),
    __self: this,
    __source: {
    ...
    className: "".concat(menuClicked ? "bg-opacity-50 bg-gray-900" : "", " fixed flex-row w-full font-sans bg-white"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 50,
...
//# sourceMappingURL=index.js.2dc627db41462b1427b6.hot-update.js.map