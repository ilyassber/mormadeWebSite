...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    ...
    className: "flex w-auto justify-center overflow-hidden",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44,
...
function StoryEntry(_ref4) {
  ...
  var sizeStyle = {
    1: {
      width: "max-w-4xl",
      descriptionSize: "w-9/12",
      style: "flex justify-start items-center w-full"
    },
    2: {
      width: "max-w-4xl",
      descriptionSize: "",
  ...
  return __jsx("div", {
    className: sizeStyle[type].style + " p-5",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 109,
...
//# sourceMappingURL=stories.js.916883abc37c685d9807.hot-update.js.map