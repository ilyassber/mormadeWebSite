...
function WelcomeBar(_ref) {
  var style = _ref.style,
      textToDisplay = _ref.textToDisplay;
  return __jsx("div", {
    className: style,
    __self: this,
    __source: {
    ...
    className: "w-full h-full overflow-hidden bg-red-900",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8,
    ...
    className: "w-full object-cover object-center opacity-25",
...
//# sourceMappingURL=stories.js.650a6e0199aab91b8d7e.hot-update.js.map