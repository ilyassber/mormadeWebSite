...
function AlphaDisplayer(_ref) {
  ...
  return __jsx("div", {
    onClick: clickAction,
    className: "flex justify-center py-5 px-5 cursor-pointer",
    __self: this,
    __source: {
    ...
    className: "relative w-full h-auto  overflow-hidden p-5 bg-red-700",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13,
...
//# sourceMappingURL=index.js.81e313d38c68764b6f50.hot-update.js.map