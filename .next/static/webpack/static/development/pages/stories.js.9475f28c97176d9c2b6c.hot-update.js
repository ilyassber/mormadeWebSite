...
function LeftCard(_ref2) {
  var image = _ref2.image,
      ...
      style = _ref2.style;
  var styleFont = {
    titleStyle: "font-kumbhsans font-bold  text-xl hover:underline cursor-pointer text-center md:text-left break-words",
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-center sm:w-full items-center",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48,
...
//     }
//     return (
//         <div className={`${width} flex flex-row justify-center`}>
//             <div className="w-full flex justify-center overflow-hidden">
//                 <img className="w-full object-cover object-center" src={image} alt="image cover" />
//             </div>
//             <div className={`flex justify-center p-5 pr-10 md:p-16 ${descriptionHeight} bg-white`}>
...
function RightCard(_ref3) {
  var image = _ref3.image,
      ...
      style = _ref3.style;
  var styleFont = {
    titleStyle: "font-kumbhsans font-bold  md:text-xl hover:underline cursor-pointer text-right break-words",
  ...
  return __jsx("div", {
    ...
    className: "flex justify-center p-5 pr-10 md:p-16 ".concat(descriptionHeight, " bg-white"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 95,
...
//# sourceMappingURL=stories.js.9475f28c97176d9c2b6c.hot-update.js.map