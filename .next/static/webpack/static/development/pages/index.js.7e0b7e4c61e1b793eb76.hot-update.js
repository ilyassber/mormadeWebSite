...
function Footer(_ref) {
  ...
  var CategoriesCard = function CategoriesCard() {
    return __jsx("div", {
      className: "my-2 mx-5 flex flex-1  flex-col justify-start items-start md:items-center md:items-start lg:pl-10 bg-red-500",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 18,
  ...
  var EntriesCard = function EntriesCard() {
    return __jsx("div", {
      className: "my-2 mx-5 flex flex-1 flex-col justify-start items-start md:items-center md:items-start",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 32,
...
//# sourceMappingURL=index.js.7e0b7e4c61e1b793eb76.hot-update.js.map