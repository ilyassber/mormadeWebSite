...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-center sm:w-full items-center p-5 px-10 md:max-w-2xl md:items-start ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48,
...
function RightCard(_ref3) {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-center sm:w-full items-center p-5 px-10  md:max-w-2xl md:items-end ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
...
//# sourceMappingURL=stories.js.69283657d3610c345635.hot-update.js.map