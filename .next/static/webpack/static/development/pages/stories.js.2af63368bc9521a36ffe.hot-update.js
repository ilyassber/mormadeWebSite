...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    className: "flex flex-row items-center justify-start w-8/12 max-w-6xl m-5 bg-red-600 ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43,
    ...
    className: "flex justify-center items-start px-5 ".concat(descriptionHeight, " "),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
...
//# sourceMappingURL=stories.js.2af63368bc9521a36ffe.hot-update.js.map