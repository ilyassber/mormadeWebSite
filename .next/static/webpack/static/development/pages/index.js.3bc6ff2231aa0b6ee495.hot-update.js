...
function SousCategoriesBar(_ref) {
  ...
  return __jsx("div", {
    className: hovredCategorie.hovered ? "transform transition-all ease-out duration-500 flex flex-col items-center w-full bg-white" : "h-0 w-full overflow-hidden bg-white",
    onMouseEnter: show,
    onMouseLeave: hide,
    __self: this,
    __source: {
...
//# sourceMappingURL=index.js.3bc6ff2231aa0b6ee495.hot-update.js.map