...
var Makers = function Makers(props) {
  var content = __jsx("div", {
    ...
    className: "w-full h-auto flex flew-wrap items-center pt-10",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 16,
    ...
    className: "w-full h-full flex flex-wrap flex-col align-center items-center content-center",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17,
    ...
    className: "w-full flex flex-wrap flex-col items-center content-center",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18,
...
//# sourceMappingURL=makers.js.7d20adee50ca5d1c2873.hot-update.js.map