...
var Btn = function Btn(props) {
  ...
  var content = __jsx("div", {
    ...
    className: 'w-full h-full bg-' + bgColor + ' ' + shadow + ' hover:bg-' + hoverColor + ' focus:outline-none focus:border-' + hoverColor + ' font-roboto font-' + textWeight + ' text-' + textColor + ' text-' + textSize + ' py-2 px-4',
    type: "button",
...
//# sourceMappingURL=index.js.cb1c298efb30ed7150b2.hot-update.js.map