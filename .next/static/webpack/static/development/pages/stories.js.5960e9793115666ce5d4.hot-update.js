...
function TitleBlock(_ref2) {
  ...
  return __jsx("div", {
    className: "flex justify-between items-center w-full h-20 border-b border-gray-300 bg-gray-100",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13,
...
function Block(_ref3) {
  ...
  return __jsx("div", {
    className: "flex justify-start items-center w-full h-16 p-5 border-b border-gray-300 bg-white",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20,
...
function SideMenu(_ref4) {
  var menuClick = _ref4.menuClick,
      ...
      links = _ref4.links;
  return __jsx("nav", {
    className: "".concat(menuClick ? "transform translate-x-0 transition-all ease-out duration-500" : "transform -translate-x-full transition-all ease-out duration-500 ", " fixed flex-row w-11/12 z-30 h-full font-bold font-sans bg-white"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 29,
...
//# sourceMappingURL=stories.js.5960e9793115666ce5d4.hot-update.js.map