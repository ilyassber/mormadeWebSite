...
function NavBar(_ref) {
  ...
  return __jsx("nav", {
    ...
    className: "text-3xl font-bold whitespace-no-wrap",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 38,
    ...
    return __jsx("li", {
      className: "m-8 cursor-pointer text-xl  hover:text-gray-500",
      key: indx,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.87a190990a405e49f461.hot-update.js.map