...
function NavBar(_ref) {
  ...
  var i_size = 15;
  return __jsx("nav", {
    className: "".concat(menuClicked ? "h-full bg-opacity-50 bg-gray-900" : "", "  z-10 relative top-0 left-0 w-full h-full bg-red-100"),
    __self: this,
    __source: {
    ...
    className: "fixed flex-row w-full font-sans bg-white",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 50,
...
//# sourceMappingURL=index.js.d99acc63484dc481c90b.hot-update.js.map