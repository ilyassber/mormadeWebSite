...
function CentredCard(_ref) {
  var image = _ref.image,
      ...
      style = _ref.style;
  var styleFont = {
    titleStyle: "font-kumbhsans font-bold  md:text-xl hover:underline cursor-pointer text-center ",
...
function LeftCard(_ref2) {
  var image = _ref2.image,
      ...
      style = _ref2.style;
  var styleFont = {
    titleStyle: "font-kumbhsans font-bold md:text-xl hover:underline cursor-pointer text-center md:text-left",
  ...
  return __jsx("div", {
    ...
    className: "max-w-3xl flex justify-center overflow-hidden",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44,
    ...
    className: "flex justify-center md:max-w-md ".concat(descriptionHeight, " "),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
    ...
    className: "flex flex-col justify-center sm:w-full items-center md:w-84 px-12 md:items-start ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48,
...
function RightCard(_ref3) {
  var image = _ref3.image,
      ...
      style = _ref3.style;
  var styleFont = {
    titleStyle: "font-kumbhsans font-bold  md:text-xl hover:underline cursor-pointer text-center md:text-right break-words",
  ...
  return __jsx("div", {
    ...
    className: "flex justify-center max-w-md   ".concat(descriptionHeight, " "),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 72,
    ...
    className: "flex flex-col justify-center items-center w-84 px-12 md:items-end ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
...
//# sourceMappingURL=stories.js.faf346299fa887b89d70.hot-update.js.map