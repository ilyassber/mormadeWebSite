...
function NavBar(_ref) {
  ...
  return __jsx("nav", {
    ...
    return __jsx("li", {
      className: "m-8 cursor-pointer text-base md:text-2xl font-bold font-worksans  text-gray-900 hover:text-gray-500",
      key: indx,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=stories.js.f2c47936575b2759c44f.hot-update.js.map