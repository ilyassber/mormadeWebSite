...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    className: "flex flex-row items-center justify-start max-w-6xl  m-5 bg-white ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43,
    ...
    className: " flex flex-col justify-center items-start p-10 ".concat(descriptionHeight, " "),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
...
//# sourceMappingURL=stories.js.85d9293b43b9a5d9e9da.hot-update.js.map