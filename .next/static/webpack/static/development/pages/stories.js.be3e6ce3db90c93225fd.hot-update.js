...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    ...
    className: "flex justify-center md:max-w-3xl ".concat(descriptionHeight, " "),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
    ...
    className: "flex flex-col justify-center sm:w-full items-center p-5 px-12  md:items-start ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48,
...
function RightCard(_ref3) {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-center sm:w-full items-center p-5 px-12  md:items-end ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
...
//# sourceMappingURL=stories.js.be3e6ce3db90c93225fd.hot-update.js.map