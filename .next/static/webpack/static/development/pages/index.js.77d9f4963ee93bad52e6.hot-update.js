...
var Layout = function Layout(props) {
  ...
  function useLockBodyScroll() {
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useLayoutEffect"])(function () {
      ...
      var originalStyle = layoutRef.current.style.overflow; // Prevent scrolling on mount

      if (openSearch) {
        layoutRef.current.style.overflow = 'hidden';
        setScroll(false);
      } else setScroll(true); // Re-enable scrolling when component unmounts


      return function () {
        return layoutRef.current.style.overflow = originalStyle;
      };
...
//# sourceMappingURL=index.js.77d9f4963ee93bad52e6.hot-update.js.map