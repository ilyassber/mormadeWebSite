...
function SideMenu(_ref) {
  ...
  return __jsx("nav", {
    className: "".concat(menuClick ? "transform translate-x-0 transition-all ease-out duration-500" : "transform -translate-x-full transition-all ease-out duration-500 ", " fixed w-11/12 z-30 h-full bg-gray-200"),
    __self: this,
    __source: {
...
//# sourceMappingURL=stories.js.9ed89177806268778c43.hot-update.js.map