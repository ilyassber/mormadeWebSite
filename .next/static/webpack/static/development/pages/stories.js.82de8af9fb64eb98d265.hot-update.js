...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    className: "flex flex-row items-center justify-start max-w-4xl  m-5 bg-white ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43,
    ...
    className: " flex flex-col justify-center items-center p-5 pr-10 md:p-16 ".concat(descriptionHeight, " "),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
...
//# sourceMappingURL=stories.js.82de8af9fb64eb98d265.hot-update.js.map