...
function SousCategoriesBar(_ref) {
  ...
  return __jsx("div", {
    className: hovredCategorie.hovered ? "transform h-96 transition-all ease-out duration-500 flex flex-col items-center w-full bg-white" : "h-0 w-full overflow-hidden bg-white",
    onMouseEnter: show,
    onMouseLeave: hide,
    __self: this,
    __source: {
...
//# sourceMappingURL=index.js.e0d2e0de57a1ef38e30e.hot-update.js.map