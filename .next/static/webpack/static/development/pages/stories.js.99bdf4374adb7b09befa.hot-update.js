...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-start sm:w-full items-center md:items-start",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48,
...
function RightCard(_ref3) {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-center sm:w-full items-end ms:items-end",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
    ...
    className: "flex items-center justify-start hover:text-green-600 bg-orange-400",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 76,
...
//# sourceMappingURL=stories.js.99bdf4374adb7b09befa.hot-update.js.map