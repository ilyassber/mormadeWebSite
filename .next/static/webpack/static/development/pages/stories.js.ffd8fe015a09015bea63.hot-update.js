...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    className: "".concat(width, " flex flex-row justify-center"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43,
  ...
  }, description)), __jsx(_graphics_textDisplayer_Text__WEBPACK_IMPORTED_MODULE_2__["default"], {
    text: title,
    style: " md:mb-1 text-gray-900",
    textStyle: styleFont.titleStyle,
    __self: this,
...
function RightCard(_ref3) {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-center items-end p-5 pr-10 md:p-16 ".concat(descriptionHeight, " bg-white"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 77,
...
//# sourceMappingURL=stories.js.ffd8fe015a09015bea63.hot-update.js.map