...
function BlackFocusScreen(_ref) {
  ...
  return __jsx("div", {
    className: display ? "absolute z-20 top-0 left-0 w-full h-full transition ease-out duration-500 bg-gray-900 bg-opacity-50" : "h-full w-full z-20 transition-all ease-out duration-500 bg-opacity-100",
    onClick: onClick,
    __self: this,
    __source: {
...
//# sourceMappingURL=stories.js.c1c08fd7e003d3ca5fc8.hot-update.js.map