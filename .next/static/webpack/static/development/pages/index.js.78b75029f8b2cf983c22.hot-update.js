...
function Footer(_ref) {
  ...
  var CategoriesCard = function CategoriesCard() {
    return __jsx("div", {
      className: "my-2 md:mx-5 flex lg:flex-1  flex-col justify-start items-start md:items-center md:items-start ",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 18,
...
//# sourceMappingURL=index.js.78b75029f8b2cf983c22.hot-update.js.map