...
function SideMenu(_ref) {
  ...
  return __jsx("nav", {
    className: "".concat(menuClick ? "transform translate-x-0 transition-all ease-out duration-500" : "transform -translate-x-full transition-all ease-out duration-500 ", " fixed w-11/12 z-20 h-full bg-gray-200"),
    __self: this,
    __source: {
...
//# sourceMappingURL=regions.js.2ac8dd1b61cc360acccb.hot-update.js.map