...
var Layout = function Layout(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    if (openSearch) {
      ...
      setScroll(window.getComputedStyle(document.body).overflow);
    } else scroll != null;
  ...
  }, [scroll]); // Empty array ensures effect is only run on mount and unmount
  //   }
  // function useLockBodyScroll() {
  //      // Get original body overflow
  //      useEffect(
  //          () => {
  //             // Prevent scrolling on mount
  //                console.log("hola hoal : ", layoutRef.current);
  //                // Re-enable scrolling when component unmounts
  //          }
  //          , []
  //      )
...
//# sourceMappingURL=index.js.5599a75855b3d192c8d0.hot-update.js.map