...
var MakerRegist = function MakerRegist(props) {
  ...
  var content = __jsx("div", {
    ...
    className: "relative w-full h-auto p-4 justify-end",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43,
    ...
    className: "w-full h-auto flex flex-wrap flex-row-reverse items-end",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 45,
    ...
    className: "h-full flex-1 content-end flex-wrap",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 46,
...
//# sourceMappingURL=index.js.b9933b844f5979472097.hot-update.js.map