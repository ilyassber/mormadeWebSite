...
function SearchGate(_ref2) {
  ...
  var DefaultBody = function DefaultBody() {
    return __jsx("div", {
      className: " animate-smouthAppearanceS flex flex-col items-center justify-start w-9/12",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 183,
  ...
  return __jsx("div", {
    className: "animate-menuSlideDownF fixed top-0 z-50 w-full flex flex-col items-center justify-start bg-white h-full",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 225,
...
//# sourceMappingURL=index.js.7a75ee406e31138bbd88.hot-update.js.map