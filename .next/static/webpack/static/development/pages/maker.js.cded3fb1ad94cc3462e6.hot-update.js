...
var UserPage = function UserPage(props) {
  ...
  var componentsList = [__jsx(_components_elements_list_ProductGridList__WEBPACK_IMPORTED_MODULE_5__["default"], {
    className: "p-2",
    data: productsList,
    __self: _this,
    __source: {
  ...
  if (!isLoading && data && data.length > 0) {
    ...
    var _productsList = JSON.parse(data).map(function (product) {
...
//# sourceMappingURL=maker.js.cded3fb1ad94cc3462e6.hot-update.js.map