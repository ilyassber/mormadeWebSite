...
function CentredCard(_ref) {
  ...
  return __jsx("div", {
    ...
    image: image,
    height: imageHeight,
    style: "flex flex-row justify-end items-center ".concat(imageHeight, " w-full  overflow-hidden"),
    imageStyle: "",
    __self: this,
    __source: {
      fileName: _jsxFileName,
    ...
    text: title,
    style: "md:hidden md:mb-1 text-white",
    ...
    text: description,
    style: " mt-2 md:mb-2  text-gray-900 ",
...
//# sourceMappingURL=stories.js.a908643818eab5d04437.hot-update.js.map