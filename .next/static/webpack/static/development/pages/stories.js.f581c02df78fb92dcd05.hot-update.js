...
function LeftCard(_ref2) {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-center sm:w-full items-center md:min-w-xl md:max-w-xl md:items-start ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48,
...
//# sourceMappingURL=stories.js.f581c02df78fb92dcd05.hot-update.js.map