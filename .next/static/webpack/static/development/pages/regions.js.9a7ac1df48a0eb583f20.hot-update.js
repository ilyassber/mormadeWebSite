...
function MiddleNav(_ref) {
  ...
  return __jsx("div", {
    ...
    return __jsx("li", {
      className: "m-8 cursor-pointer text-base font-semibold md:text-xl font-zillaslab tracking-wide  text-gray-900 hover:text-gray-700",
      key: indx,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=regions.js.9a7ac1df48a0eb583f20.hot-update.js.map