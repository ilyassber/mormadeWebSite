...
function ArticleCover(_ref) {
  ...
  return __jsx("div", {
    className: "relative flex flex-col justify-start items-center w-full h-288 bg-green-100",
    __self: this,
    __source: {
    ...
    title: title,
    style: "flex justify-center items-center w-64 h-32 font-bold text-3xl",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9,
    ...
    image: image,
    style: "w-10/12 h-204 overflow-hidden bg-gray-400 shadow-xl",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10,
...
//# sourceMappingURL=index.js.79e18f7188b23bfc1b5a.hot-update.js.map