...
function AlphaDisplayer(_ref) {
  ...
  return __jsx("div", {
    ...
    image: image,
    height: height,
    style: "flex flex-col justify-end items-center p-10 ".concat(height, " ").concat(width, " shadow-lg"),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14,
...
//# sourceMappingURL=index.js.dceff5267f9dcde2a92f.hot-update.js.map