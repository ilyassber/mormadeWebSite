...
function Cover1(_ref2) {
  ...
  return __jsx("div", {
    className: "relative flex overflow-hidden py-5 px-5 bg-gray-900",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18,
    ...
    className: "absolute flex justify-center z-10 w-full h-full ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20,
    ...
    className: "inline-block bg-red-600 w-1/2 h-1/2",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21,
...
//# sourceMappingURL=stories.js.5dcdd36af7e0c706f9da.hot-update.js.map