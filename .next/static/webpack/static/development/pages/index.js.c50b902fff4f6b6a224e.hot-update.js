...
function AlphaDisplayer(_ref) {
  ...
  var textStyle = {
    ...
    descriptionStyle: "m-2 tracking-wide font-bold text-base text-center text-white",
  ...
  return __jsx("div", {
    ...
    className: "flex justify-center items-center px-5 py-2 mb-10 mt-2 bg-white ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19,
...
//# sourceMappingURL=index.js.c50b902fff4f6b6a224e.hot-update.js.map